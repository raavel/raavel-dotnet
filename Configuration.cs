...
{
    /// <summary>
    /// Defines the configuration for a sending notifications to Raavel
    /// </summary>
    public class Configuration : IConfigurationStorage
    {
        ...
        /// </summary>
        /// <param name="apiKey">The API key linked to a Raavel account</param>
        ...
        /// <summary>
        /// Adds a BeforeNotify callback to be called before an error is sent to Raavel
        /// </summary>
        /// <param name="callback">The callback to be called before notifying Raavel</param>
        ...
        /// </summary>
        /// <param name="errorEvent">The event that will be sent to Raavel</param>
        ...
        /// </summary>
        /// <param name="errorEvent">The error that will be sent to Raavel</param>
