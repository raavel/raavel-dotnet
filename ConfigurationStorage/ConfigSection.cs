...
namespace Raavel.ConfigurationStorage
{
    ...
    {
        private static ConfigSection _storage = ConfigurationManager.GetSection("raavelConfig") as ConfigSection;
        ...
        [ConfigurationProperty("endpoint", IsRequired = false, DefaultValue = "https://api.raavel.com/notify/event")]
        [StringValidator]
